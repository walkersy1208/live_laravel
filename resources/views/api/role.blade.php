        ...
        <div class="container">
            ...
            <div>
                <modal-component title="提示信息" :is_input=true :fields="[
                    ...
                    ]" msg="添加成功" status="success" request_url="/api/add_role">
                            ...
                            <td>
                                <div class="" role="group">
                                    <div type="button" class="btn btn-success ">
                                        ...
                                        ]" msg="修改成功" status="success" request_url="/api/edit_role/{{ $role->id }}">
                                        </edit-component>
                                    </div>
                                    <button type="button" class="btn btn-danger">
                                        <comfirm-component request_url="/api/delete_role/{{ $role->id }}" ></comfirm-component>
                                    </button>
                                </div>
                            </td>
                        </tr>
